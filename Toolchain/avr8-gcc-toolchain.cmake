...
####################
  ...
  set (CMAKE_CXX_FLAGS_DEBUG "-O0 -g -gdwarf-2 -fno-exceptions ${FULL_OPTIONS} " CACHE STRING "Default C++ flags for debug configuration" FORCE )
  set (CMAKE_C_FLAGS_DEBUG " -O0 -g -gdwarf-2 ${FULL_OPTIONS} " CACHE STRING "Default C flags for debug configuration" FORCE )
#endif()
